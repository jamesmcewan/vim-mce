" mce - A 24-bit Material color scheme for Vim
...
set background=dark
let g:colors_name = 'mce'

let g:mce_italics = get(g:, 'mce_italics', 0)
let g:mce_black = get(g:, 'mce_black', 0)

" Color Palette
let s:gray1     = g:mce_black ? '#0b011c' : '#0b011c'
let s:gray2     = g:mce_black ? '#292929' : '#2c3a41'
let s:gray3     = g:mce_black ? '#474646' : '#425762'
let s:gray4     = g:mce_black ? '#6a6c6c' : '#658494'
let s:gray5     = g:mce_black ? '#b7bdc0' : '#aebbc5'
let s:red       = '#ff2e97'
let s:green     = '#a7da1e'
let s:yellow    = '#50e3c2'
let s:blue      = '#42c6ff'
...
function! s:HL(group, fg, bg, attr)
    let l:attr = a:attr
    if !g:mce_italics && l:attr ==# 'italic'
        let l:attr = 'none'
    endif
